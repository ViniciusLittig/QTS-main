                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="btn-group">
                                    <a href="https://localhost/QTS-main/" class="btn btn-warning">
                                        <i class="fas fa-chevron-left"> </i> Voltar
                                    </a>
                                    <a href="https://localhost/QTS-main/pessoa" class="btn btn-success">
                                        <i class="fas fa-plus"> </i> Cadastrar
                                    </a>                         
                                </div> 
                                    <!--Consulta-->
                                    <div class="form-group input-group" style="padding: 10px;">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr id="listapessoa<?php echo $value->idpessoa; ?>">
                                                ...
                                                <td>
                                                    <a href="https://localhost/QTS-main/pessoa?id=<?php echo $value->idpessoa; ?>" class="btn btn-warning">
